...
public class AdminOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle b) {
        ...
        ((TextView) findViewById(R.id.adminListTitle)).setText("Manage Orders");
    ...
    void renderOrders() {
        list.removeAllViews();
        List<String[]> os = OrderManager.all(this);
        if (os.isEmpty()) {
        ...
        for (String[] o : os) {
            ...
            btn.setText("Update Status");
            btn.setOnClickListener(v -> chooseStatus(o[0]));
            card.addView(btn);
    ...
    void addText(String s) {
        ...
        t.setText(s);
        t.setTextSize(16);
        t.setPadding(16, 24, 16, 24);
        list.addView(t);
    }

    void chooseStatus(String id) {
        new AlertDialog.Builder(this).setTitle("Update Order " + id).setItems(statuses, (d, w) -> {
            OrderManager.updateStatus(this, id, statuses[w]);
